...
const Slide = () => {
     ...
     return (
          <div className={cn('relative h-[14rem] md:h-[30rem] w-full flex items-center',{'justify-center':slide==0})}>
          ...
          <div className='text-black relative  px-20 '>
                    <h2 className='text-xl md:text-2xl font-semibold transition-transform duration-300'>{gallery.at(0)!.text.heading}</h2>
                    <h1 className=' text-3xl md:text-6xl font-bold'>{gallery.at(slide)!.text.subheading}</h1>
                    <p className='text-xs md:text-xl font-semibold'>  {gallery.at(slide)!.text.description}</p>
